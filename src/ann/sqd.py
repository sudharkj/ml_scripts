...
# We compare the progression of the cost function vs. iteration for 3 cases:
# 1) full gradient descent
# 2) batch gradient descent
# 3) stochastic gradient descent

# We use the PCA-transformed data to keep the dimensionality down (D=300)
# What we are comparing is how quickly each type of GD can converge,
# (but not actually waiting for convergence) and what the cost looks like
# at each iteration.
